...
@Component({
  ...
  imports: [FormField, EncodeBase64, SwalComponent],
...
export class ProductForm implements CanDeactivateComponent {
  ...
  protected exitConfirm = viewChild.required<SwalComponent>('exitConfirm');
  ...
  async canDeactivate() {
    ...
    const result = await this.exitConfirm().fire();
